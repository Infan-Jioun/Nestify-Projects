...
export default function ApartmentPage() {
  ...
  const [apartmentProperties, setHouseProperties] = useState<PropertyType[]>([])
  ...
  useEffect(() => {
    const apartments = properties.filter(property =>
      property.category?.name?.toLowerCase() === 'apartment'
    )
    setHouseProperties(apartments)
  }, [properties])
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="py-8">
        <div className="container mx-auto px-4">
          ...
          {/* Empty State */}
          {!loading && !error && apartmentProperties.length === 0 && (
            <div className="text-center py-12">
