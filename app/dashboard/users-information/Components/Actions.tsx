...
const roles = ["user", "admin", "real_estate_developer"]
        ...
        <div className="flex space-x-2">
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button variant="outline" size="sm" className="flex-1 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 border-0 text-gray-700 dark:text-gray-300 hover:scale-105 transition-transform duration-200 rounded-xl">
                ...
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <RadioGroup value={selectedRole}
                        onChange={() => dispatch(updateUserRole({ id: user._id, role: selectedRole }))}
