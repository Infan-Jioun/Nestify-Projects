        ...
        <>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <button
                    ...
                    disabled={isEditing}
                    className={`w-full mb-4 py-3 px-4 rounded-lg font-medium transition duration-200 flex items-center justify-center bg-green-500 hover:bg-green-600 text-white disabled:opacity-50 disabled:cursor-not-allowed`}
                >
                    {copied ? (
                        <>
