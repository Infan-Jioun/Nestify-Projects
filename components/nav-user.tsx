              ...
              <DropdownMenuItem asChild>
                <Link href="/LoginPage" className="w-full">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-full px-4 flex justify-center items-center p-2 gap-2 rounded-full bg-green-500 text-white hover:bg-green-500 hover:text-white  font-semibold transition"
                  >
                    <LogInIcon /> Login
                  </motion.button>
                </Link>
